...
public class TreeDemoFrame extends JFrame {
    ...
    private JButton maxLeaveButton;
    private JLabel maxLeaveLabel;
    ...
    public TreeDemoFrame() {
        ...
        maxLeaveButton.addActionListener(actionEvent -> {
            try {
                if (this.tree == null) {
                    BinaryTree<Integer> tree = new BinaryTree<>(s -> Integer.parseInt(s));
                    tree.fromBracketNotation(textFieldBracketNotationTree.getText());
                ...
                int node = Test.getMaxLeaveValue(this.tree);
                maxLeaveLabel.setText("" + node);
            } catch (Exception ex) {
                SwingUtils.showErrorMessageBox(ex);
            }
        });
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        maxLeaveButton = new JButton();
        maxLeaveButton.setBackground(new Color(-7948238));
        maxLeaveButton.setText("наибольший лист дерева");
        panel8.add(maxLeaveButton, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        maxLeaveLabel = new JLabel();
        maxLeaveLabel.setText(".....");
        panel8.add(maxLeaveLabel, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final Spacer spacer8 = new Spacer();
        panel8.add(spacer8, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
